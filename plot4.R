...
#Second Plot
plot(changed$Datetime, changed$Voltage, type="l", main="",xlab="datetime",ylab="Voltage")
#Third Plot
...
#Fourth Plot
plot(changed$Datetime, changed$Global_reactive_power, type="l", main="",xlab="datetime",ylab="Global_reactive_power")
#Saving to file
